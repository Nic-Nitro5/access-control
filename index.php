...
<section>
    <div class="container card rounded bg-white shadow-sm my-4 p-4">
        ...
        <?php if(!empty($_SESSION['user']['username'])){ ?>
            <div class="alert alert-success">Welcome <?php echo ucwords($_SESSION['user']['username']); ?> <a class="float-end" href="my_account.php">Settings</a></div>
        <?php } ?>
        <h3>All Visitors</h3>
        <table class="table table-striped table-hover"> 
            ...
            <?php }}else{
                echo '<h6 class="text-danger">No visitor information recorded yet.</h6>';
            } ?>
        </table>
    </div>
</section>
